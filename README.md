...
1. Access Kibana -> Stack Management -> Index Patterns
...
2. Create Index Patterns -> Input index name (ex. filebeat-es-*.log)
...
4. Kibana -> Analytics -> Check your dashboard in Discover
